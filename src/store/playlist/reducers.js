...
const playlist = (state = { index: null, page: null }, action) => {
  switch (action.type) {
    ...
    case P.DELETE_VID:
      const filteredpart = state.list[action.page].filter((e) => e.videoId !== action.vidID);
      const newlist = [...state.list];
      newlist[action.page] = filteredpart;
